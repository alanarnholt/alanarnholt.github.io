...
output: 
  html_document:
    ...
    toc_float:
      collapsed: false
---
## Office Hours <i class="fa fa-clock-o"></i> Spring 2020

My office is in 237 Walker Hall. Students may click on [book now](https://arnholtat.youcanbook.me/) to schedule an appointment. Office hours are M, W, and F 12:30 PM to 2:00 PM; and by appointment. 

```{r, echo = FALSE}
df <- data.frame(Time = c("6:00-9:00", "9:30-10:45", "11:00-12:15", "12:30-1:45", "2:00-3:00", "3:00-4:00", "4:00-5:00"), 
                 Monday = c("PT", "Research", "Research", "Office", "Prep", "NICA",  "NICA"), 
                 Tuesday = c("PT", "STT 2810", "STT 2810", "STT 3860", "Prep", "Prep",  "Prep"), 
                 Wednesday = c("PT", "Research", "Research", "Office", "Prep", "Meeting",  "Prep"), 
                 Thursday = c("PT", "STT 2810", "STT 2810", "STT 3860", "Prep", "NICA",  "NICA"),  
                 Friday = c("PT", "Research", "Research", "Office", "Prep", "Prep",  "Prep")) 
knitr::kable(df, align = c("c","c","c","c","c","c","c"))
```
...
- Final Exam STT 2810-112 Rankin Science 294; May 7, 2020---8:00 AM - 10:30 AM
- Final Exam STT 2810-113 Rankin Science 294; May 5, 2020---11:00 AM - 1:30 PM
- Final Exam STT 3860-101 Rankin Science; May 7, 2020---11:00 AM - 1:30 PM
