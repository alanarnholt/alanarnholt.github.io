...
output: 
  html_document:
    ...
    toc_float:
      collapsed: false
---
## Office Hours <i class="fa fa-clock-o"></i> Spring 2019

My office is in 237 Walker Hall. Students may click on [book now](https://arnholtat.youcanbook.me/) to schedule an appointment. Office hours are M-R 1:00 PM to 2:00 PM; and by appointment. 

```{r, echo = FALSE}
df <- data.frame(Time = c("6:00-9:00", "9:00-10:00", "10:00-11:00", "11:00-12:00", "12:00-1:00", "1:00-2:00", "2:00-3:00", "3:00-3:30", "4:00-5:00"), 
                 Monday = c("PT", "Research/Prep", "Research/Prep", "Research/Prep", "Lunch", "Office Hour",  "Research/Prep", "Research/Prep", "STT 2820"), 
                 Tuesday = c("PT", "Research/Prep", "Research/Prep", "Research/Prep", "Lunch", "Office Hour",  "STT 3531", "STT 3531", "STT 2820"), 
                 Wednesday = c("PT", "Research/Prep", "Research/Prep", "Research/Prep", "Lunch", "Office Hour",  "Dept Meeting", "Research/Prep", "STT 2820"), 
                 Thursday = c("PT", "Research/Prep", "Research/Prep", "Research/Prep", "Lunch", "Office Hour",  "STT 3531", "STT 3531", "STT 2820"),  
                 Friday = c("PT", "Research", "Research", "Research", "Lunch", "Research",  "Colloquium", "Research", "Research")) 
...
- Final Exam STT 3531-101 Walker 303; MAY 7, 2018---2PM - 4:30PM
- Final Exam STT 2820-108 Walker 303; MAY 8, 2018---2PM - 4:30PM
